...
const stockMovementSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: [
      'stock_in', 'dispense', 'bill_deduct', 'dispose', 'adjustment', 'expiry_alert', 'reorder', 'sale',
      'stock_adjustment_reduce', 'stock_adjustment_increase',
      'purchase', 'purchase_return', 'sale_return',
      'adjustment_in', 'adjustment_out',
      'transfer_in', 'transfer_out',
      'expired', 'damaged', 'opening_stock',
    ],
    required: true,
    index: true,
  },
