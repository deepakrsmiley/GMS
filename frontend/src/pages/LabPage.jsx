...
const buildResultFields = (labOrder) => {
  ...
  const pushRow = (t, profileName, meta = {}) => {
    fields.push({
      ...
      section: t.isSection ? t.testName : shortProfileName(profileName || t.profileName || 'Other'),
      value: '',
      unit: meta.unit || t.unit || '',
      normalRange: meta.normalRange || t.normalRange || '',
      method: t.method || meta.method || '',
      criticalLow: meta.criticalLow,
      criticalHigh: meta.criticalHigh,
      flag: 'NA',
      referenceRange: meta.normalRange || t.normalRange || '',
      included: false,
      custom: false,
    });
  };
