...
export const NAV_ITEMS = [
  ...
  { id: 'lab-daily',        to: '/lab?tab=daily',           label: 'Lab Day Report',     icon: 'FileBarChart2',   permission: 'VIEW_LAB',               module: 'lab', group: 'clinical', roles: ['Super Admin', 'Admin', 'Lab Technician'] },
